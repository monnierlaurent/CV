createModalHeader = () => {
    ...
    icon1.addEventListener('click', () => {
        ...
        divContainer.setAttribute('class', 'body--blur');
        ...
        modals('fab fa-html5', './index.html', parag1, '');
    });
    ...
    icon2.addEventListener('click', () => {
        ...
        modals('fab fa-js-square', './index.html', parag2, '');
    ...
    icon3.addEventListener('click', () => {
        ...
        modals('fab fa-vuejs', './index.html', parag3, '');
    ...
    icon4.addEventListener('click', () => {
        ...
        modals('fab fa-node', './index.html', parag4, '');
    ...
    icon5.addEventListener('click', () => {
        ...
        modals('fab fa-css3-alt', './index.html', parag5, '');
